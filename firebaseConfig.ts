...
export const firebaseConfig = {
  // --- IMPORTANT ---
  // The API key must be a string directly in this object for the app to work in the browser.
  // Replace "YOUR_FIREBASE_API_KEY" with the actual key from your Firebase project settings.
  apiKey: "AIzaSyDJsCrjru40rvrL9Js6XOL72R60v9yLyGk",
  authDomain: "minka-6e6c9.firebaseapp.com",
  projectId: "minka-6e6c9",
  storageBucket: "minka-6e6c9.firebasestorage.app",
